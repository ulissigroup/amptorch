...
from amptorch.uni.NN_uni import FullNN, CustomLoss
from amptorch.uni.data_uni import AtomsDataset, factorize_data, collate_amp, TestDataset
...
# images = read("../../datasets/COCu/COCu_pbc_300K.traj", ":100")
