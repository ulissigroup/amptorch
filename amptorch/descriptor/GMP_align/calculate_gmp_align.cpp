...
extern "C" int calculate_gmp_align_noderiv(double** cell, double** cart, double** scale, int* pbc_bools,
                                        int* atom_i, int natoms, int* cal_atoms, int cal_num,
                                        int** params_i, double** params_d, int nmcsh, int total_num_desc, double** atom_gaussian, int* ngaussians, int* element_index_to_order,
                                        double** mcsh) {
    ...
    for (int ii=0; ii < cal_num; ++ii) {
        ...
        for (int m = 0; m < nmcsh; ++m) {
            ...
            if (mcsh_type == 2){
                ...
                else if (first_alignment_vector_calculated == false){
                ...
                // mcsh[ii][desc_counter + 1] += sum_miu2 * weight;
                // mcsh[ii][desc_counter + 2] += sum_miu3 * weight;
                // desc_counter = desc_counter + 3;
            ...
            if (mcsh_type == 3){
                ...
                if (first_alignment_vector_calculated && second_alignment_vector_calculated){
                    ...
                    find_quaternion1_six_major(temp_vec, first_quaternion);
                    apply_quaternion_six(temp_vec, first_quaternion);

                    find_quaternion2_six_minor(temp_vec, second_quaternion);
                    apply_quaternion_six(temp_vec, second_quaternion);
                    ...
                    find_quaternion2_six_major(temp_vec, second_quaternion);
                    apply_quaternion_six(temp_vec, second_quaternion);
                ...
                // mcsh[ii][desc_counter + 1] += sum_miu2 * weight;
                // mcsh[ii][desc_counter + 2] += sum_miu3 * weight;
                // mcsh[ii][desc_counter + 3] += sum_miu4 * weight;
                // mcsh[ii][desc_counter + 4] += sum_miu5 * weight;
                // mcsh[ii][desc_counter + 5] += sum_miu6 * weight;
                // desc_counter = desc_counter + 6;
...
extern "C" int calculate_gmp_no_align_noderiv(double** cell, double** cart, double** scale, int* pbc_bools,
                                        int* atom_i, int natoms, int* cal_atoms, int cal_num,
                                        int** params_i, double** params_d, int nmcsh, int total_num_desc, double** atom_gaussian, int* ngaussians, int* element_index_to_order,
                                        double** mcsh) {
