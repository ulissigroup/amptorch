...
class WeightedAtomsDataset(Dataset):
    """
    ...
    def __init__(
        ...
        self.unique_atoms, self.fingerprint_dataset, self.energy_dataset,\
            ...
            self.index_hashes, self.weights = self.preprocess_data()
    ...
    def preprocess_data(self):
        ...
        for index, hash_name in enumerate(self.hashed_images.keys()):
            ...
            index_weights.append(self.weights_dict[hash_name])
...
def weighted_collate_amp(training_data):
    """
    ...
    """
    unique_atoms, fingerprint_dataset, energy_dataset, num_of_atoms, fp_primes, image_forces, weights = factorize_data(
        training_data
    )
