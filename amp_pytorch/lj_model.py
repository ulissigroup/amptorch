...
class lj_optim:
    ...
    def fit(self, filename="results/lj_log.txt", method="Nelder-Mead"):
        ...
        self.target_forces = np.concatenate([(atoms.get_forces()) for atoms in self.data])
        ...
        self.logresults(log, self.data, self.cutoff, self.p0, self.params_dict,
                        lj_min)
    ...
    def lj_pred(self, params):
        ...
        for image in self.data:
            ...
            pairs, distances = get_distances(image, [(self.cutoff + 1e-10) / 2] * natoms)
            V = 0
    ...
    def objective_fn(self, params, target_energies, target_forces):
        predicted_energies, predicted_forces, num_atoms = self.lj_pred(params)
    ...
    def logresults(self, log, data, cutoff, p0, params_dict, results):
        log("-" * 50)
    ...
    def parity(self, predicted_energies, predicted_forces):
        ...
        ax.plot([energy_min, energy_max], [energy_min, energy_max], "r-",
                lw=0.5)
