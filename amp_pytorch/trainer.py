...
def train_model(
    ...
    while best_loss >= rmse_criteria:
        ...
        for data_sample in atoms_dataloader:
            ...
            # print(image_forces.requires_grad)
            # print(scaled_target.requires_grad)
            ...
            def closure():
                ...
                loss_test = test(
                    energy_pred, scaled_target, force_pred, image_forces, num_of_atoms
                )
                loss_test.backward()
                return loss_test
                # return loss
            ...
            # with torch.no_grad():
            scaled_preds, force_pred = model(input_data, fp_primes)
