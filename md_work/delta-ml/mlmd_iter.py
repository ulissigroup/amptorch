...
def mlmd_run(
    ...
    net = NeuralNetRegressor(
        module=FullNN(
            unique_atoms, [fp_length, 4, 30], device,
            forcetraining=forcetraining
        ),
...
# ber_images = ase.io.read("../../datasets/COCu_ber_50ps_300K.traj", ":2000:10")
ber_images = ase.io.read("../../datasets/COCu_ber_50ps_300K.traj", ":100")
# ber_images = ase.io.read("../../datasets/COCu/COCu_aimd_300K.traj", ":2000:10")
...
basename = "COCu_morse_mdseed_f100_2"
iterative_sampler(
    images=ber_images,
    count=2000,
    sample=num_samples,
