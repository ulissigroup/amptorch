...
def main():
    ...
    md_runner.run_md(calc=EMT(), count=10, filename="COCu_EMT_5ps")
    # training_data = md_runner.get_trajectory(
        # filename="COCu_EMT_5ps", start_count=0, end_count=2000, interval=10
    # )
    print(md_runner.starting_geometry.get_calculator())
    sys.exit()
