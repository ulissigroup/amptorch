...
import numpy as np
from amptorch.NN_model import CustomLoss, TanhLoss, MAELoss
...
def ml_lj(
    ...
    if lj:
        ...
        params_dict = {"C": [], "O": [], "Cu": []}
        lj_model = lj_optim(
            IMAGES, p0, params_dict, cutoff, filename, forcetraining=True
        )
...
images_ML_l2 = ase.io.read(
    "MD_results/COCu/pbc_300K/l2amp/MLMD_COCu_pbc_300K_l2amp_30x30-1.traj", ":"
)
images_LJ_l2 = ase.io.read(
    "MD_results/COCu/pbc_300K/l2amp/MLMD_COCu_pbc_300K_l2amp_30x30-LJ-1.traj", ":"
)
images_ML_tanh = ase.io.read(
    "MD_results/COCu/pbc_300K/tanh/MLMD_COCu_pbc_300K_tanh_30x30-1.traj", ":"
)
images_LJ_tanh = ase.io.read(
    "MD_results/COCu/pbc_300K/tanh/MLMD_COCu_pbc_300K_tanh_30x30-LJ-2.traj", ":"
)
...
num_images = 100
num_samples = 10
sample_points = random.sample(range(1, 30), num_samples)
jobs = []
p3 = multiprocessing.Process(
    target=multiple_samples,
    args=(
        images0,
        images_ML_tanh,
        "MLMD_COCu_pbc_300K_mae_30x30",
        "MD_results/",
        100,
        sample_points,
        2,
