...
#     print(x0)
    res = minimize(mae_function_regularized, x0, (r,ref, num_elec), method='nelder-mead',  
...
#     print(num_gaussian)
    optimized, integration = optimize_coeff(x0, r, ref, num_elec, plot_filename = plot_filename)
...
def optimize_atom_and_save(atom, num_elec, num_gaussian, log_filename = "info.log"):
    ...
    optimized_gaussian, error, integration = get_optimized_gaussian(r,total_density,num_gaussian, num_elec,plot_filename = plot_filename)
    save_gaussian(r, optimized_gaussian, atom, density_type = "totaldensity", num_gaussian = num_gaussian)
    msg = "atom:{}\ttype:{}\tngaussian:{}\tmse:{}\tintegration:{}\n".format(atom, "totaldensity", num_gaussian, error, integration)
    print(msg)
...
if __name__ == "__main__": 
    for atom, num_elec in [("H",1),
        ...
        for num_gaussian in range(2,9):
            optimize_atom_and_save(atom, num_elec, num_gaussian, log_filename = "info.log")