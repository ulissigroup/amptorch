...
count_arr = np.zeros((test_len, len(refdata)))
target = np.zeros(test_len)
...
print("test MAE: {}".format(np.mean(np.abs(error))))
print("test MSE: {}".format(np.mean(np.square(error))))
